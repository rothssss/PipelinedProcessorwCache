...
if (@ARGV[0] eq "") {
    print "\ncalc_metal2.pl \<magic file\>\n\n";
    print " this script will calculate the metal2 density of your layout\n\n";
}
...
print "calculating total metal2 area\.\.\.\n";
...
print "====================================================\n";
print "Total Metal2 Area = $totarea lambda squared\n";
$density = $totarea/121000000;
$percent_density = $density * 100;


printf ("given 11000 x 11000 area, total metal2 density = %2.5f percent\n", $percent_density);
